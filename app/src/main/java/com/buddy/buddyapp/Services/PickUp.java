package com.buddy.buddyapp.Services;
...
import com.buddy.buddyapp.Activities.OrderConfirmActivity;
import com.buddy.buddyapp.Constant.Common;
import com.buddy.buddyapp.Constant.PopUp;
import com.buddy.buddyapp.Interface.IServiceLoadListener;
                ...
                if (position > 0 )
                {
                    ...
                    btn_next.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            int priceD = Integer.parseInt(split);
                            int priceU = Integer.parseInt(altPrice);
                            //int i = splitPrice.length;

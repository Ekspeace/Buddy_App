...
import com.buddy.buddyapp.Adapter.BookingInfoAdapter;
...
import com.buddy.buddyapp.Interface.IBookingInfoLoadListener;
    ...
    private void deleteBookingFromSlot() {
        ...
        if (Common.isOnline(this)) {
            ...
            BookingInfo.delete().addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    com.buddy.buddyapp.Constant.PopUp.smallToast(BookingActivity.this, layout, R.drawable.small_error,e.getMessage(),Toast.LENGTH_SHORT);
                    dialog.setVisibility(View.GONE);
                }
        ...
        if (Common.isOnline(this)) {
            ...
            userBookingInfo1.delete().addOnFailureListener(new OnFailureListener() {
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    dialog.setVisibility(View.GONE);
                    com.buddy.buddyapp.Constant.PopUp.smallToast(BookingActivity.this, layout, R.drawable.small_success,"Successfully deleted the booking !",Toast.LENGTH_SHORT);

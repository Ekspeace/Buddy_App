...
import com.buddy.buddyapp.Adapter.OrderInfoAdapter;
...
import com.buddy.buddyapp.Interface.IOrderInfoLoadListener;
    ...
    private void deleteOrderFromUser() {
        ...
        if (Common.isOnline(this)) {
            ...
            userOrderInfo.delete().addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    com.buddy.buddyapp.Constant.PopUp.smallToast(OrderingActivity.this, layout, R.drawable.small_error, e.getMessage(),Toast.LENGTH_SHORT);
                    dialog.setVisibility(View.GONE);
                }
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    dialog.setVisibility(View.GONE);
                    com.buddy.buddyapp.Constant.PopUp.smallToast(OrderingActivity.this, layout, R.drawable.small_success, "Successfully deleted the order!",Toast.LENGTH_SHORT);

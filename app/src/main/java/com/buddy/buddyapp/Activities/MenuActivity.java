...
import com.buddy.buddyapp.Adapter.MyServiceAdapter;
import com.buddy.buddyapp.BookingActivity;
import com.buddy.buddyapp.Constant.Common;
import com.buddy.buddyapp.Constant.PopUp;
import com.buddy.buddyapp.Constant.SpacesItemDecoration;
import com.buddy.buddyapp.Interface.ICategoryLoadListener;
import com.buddy.buddyapp.Model.Services;
import com.buddy.buddyapp.R;
import com.buddy.buddyapp.Services.PickUp;
...
public class MenuActivity extends AppCompatActivity implements ICategoryLoadListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    public void onCategoryLoadFailed(String message) {
        com.buddy.buddyapp.Constant.PopUp.smallToast(MenuActivity.this, layout, R.drawable.small_error,message,Toast.LENGTH_SHORT);
        ArcProgress.setVisibility(View.GONE);
        ...
        switch (menuItem.getItemId()){
            ...
            case R.id.rate:
               rateMe();
                break;
            case R.id.whatsapp:
                com.buddy.buddyapp.Constant.PopUp.Whatsapp(this, "WhatsApp...", "Chat with us on WhatsApp", R.drawable.whatsapp);
                break;
            case R.id.SignOut :

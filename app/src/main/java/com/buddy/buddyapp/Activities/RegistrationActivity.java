...
public class RegistrationActivity extends AppCompatActivity {
        ...
        if (Common.isOnline(RegistrationActivity.this)) {
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                if (task.isSuccessful()) {
                    com.buddy.buddyapp.Constant.PopUp.smallToast(RegistrationActivity.this, layout, R.drawable.small_success,"Registration successfully, Please verify your phone number",Toast.LENGTH_LONG);
                    Paper.book().destroy();
                    ...
                    documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            com.buddy.buddyapp.Constant.PopUp.smallToast(RegistrationActivity.this, layout, R.drawable.small_error, "Error ! " + task.getException().getMessage(),Toast.LENGTH_SHORT);
                        }
                    });
                ...
                public void onFailure(@NonNull Exception e) {
                    loadingbar.setVisibility(View.GONE);
                    com.buddy.buddyapp.Constant.PopUp.smallToast(RegistrationActivity.this, layout, R.drawable.small_error, "Error ! " + e.getMessage(),Toast.LENGTH_SHORT);
                }
            });
        } else {
            loadingbar.setVisibility(View.GONE);
    ...
    public void onBackPressed() {
        ...
        if (t - backPressedTime > 2000) {    // 2 secs
            backPressedTime = t;
            com.buddy.buddyapp.Constant.PopUp.smallToast(RegistrationActivity.this, layout, R.drawable.small_error,"Please press again to exit...",Toast.LENGTH_SHORT);
        } else {
            System.exit(0);
        }
    }

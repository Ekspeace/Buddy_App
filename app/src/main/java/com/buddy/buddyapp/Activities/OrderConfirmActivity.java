                                ...
                                userOrder.document()
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                com.buddy.buddyapp.Constant.PopUp.smallToast(OrderConfirmActivity.this, layout, R.drawable.small_success,"Successfully Ordered!",Toast.LENGTH_SHORT);
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                dialog.setVisibility(View.GONE);
                                                com.buddy.buddyapp.Constant.PopUp.smallToast(OrderConfirmActivity.this, layout, R.drawable.small_error,e.getMessage(),Toast.LENGTH_SHORT);
                                            }
                                        });
                            } else {
                                dialog.setVisibility(View.GONE);
                                com.buddy.buddyapp.Constant.PopUp.smallToast(OrderConfirmActivity.this, layout, R.drawable.small_error,"Sorry... but already ordered, Delete history orders",Toast.LENGTH_SHORT);
                                startActivity(new Intent(OrderConfirmActivity.this, MenuActivity.class));
                                finish();
                            }
                        }

...
public class EditOrderActivity extends AppCompatActivity {
                                        ...
                                        userOrder
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        com.ekspeace.buddyapp.Constant.PopUp.smallToast(EditOrderActivity.this, layout, R.drawable.small_success,"Successfully Order is update!",Toast.LENGTH_SHORT);
                                                ...
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        dialog.setVisibility(View.GONE);
                                                        com.ekspeace.buddyapp.Constant.PopUp.smallToast(EditOrderActivity.this, layout, R.drawable.small_error,e.getMessage(),Toast.LENGTH_SHORT);
                                                    }
                                                });
                                           ...
                                           userOrder.update(orderInformation);

                                    } else {
                                        dialog.setVisibility(View.GONE);
                                        com.ekspeace.buddyapp.Constant.PopUp.smallToast(EditOrderActivity.this, layout, R.drawable.small_error,"Sorry... your order is not updated",Toast.LENGTH_SHORT);
                                        startActivity(new Intent(EditOrderActivity.this, OrderingActivity.class));
                                        finish();
                                    }
                                }
                    ...
                    if (task.isSuccessful()) {
                        if (!Objects.requireNonNull(task.getResult()).isEmpty()) {
                            for (QueryDocumentSnapshot queryDocumentSnapshot : task.getResult()) {
                                ...
                                AssignOrder(orderInformation, queryDocumentSnapshot);
                                orderInformationList.add(orderInformation);

                            }
                            InformationList = orderInformationList;
                            AssignEditText(orderInformationList);
                            dialog.setVisibility(View.GONE);
                        } else {
    ...
    private void AssignEditText(List<OrderInformation> information) {
        if(information.get(Common.OrderPosition).getCategoryname().contains("b")) {
            layout_cannabis.setVisibility(View.VISIBLE);
            layout_grocery.setVisibility(View.GONE);
            layout_other.setVisibility(View.GONE);
            loadCannabis(information.get(Common.OrderPosition));
            String splitPrice = information.get(Common.OrderPosition).getCannabisPrice();
            String split = splitPrice.substring(1,splitPrice.length());
            price.setText(split);

        }
        if(information.get(Common.OrderPosition).getCategoryname().contains("G")){
            layout_grocery.setVisibility(View.VISIBLE);
            layout_other.setVisibility(View.GONE);
            layout_cannabis.setVisibility(View.GONE);
            btn_update.setEnabled(true);
            et_grocery_store.setText(information.get(Common.OrderPosition).getGroceryStore());
            et_grocery_list.setText(information.get(Common.OrderPosition).getGroceryList());
        }
        if(information.get(Common.OrderPosition).getCategoryname().contains("h")){
            btn_update.setEnabled(true);
            layout_other.setVisibility(View.VISIBLE);
            layout_cannabis.setVisibility(View.GONE);
            layout_grocery.setVisibility(View.GONE);
            et_other_type.setText(information.get(Common.OrderPosition).getOtherType());
            et_other_type_info.setText(information.get(Common.OrderPosition).getOtherInfo());
        }

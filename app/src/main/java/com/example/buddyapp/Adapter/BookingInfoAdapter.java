...
public class BookingInfoAdapter extends RecyclerView.Adapter<BookingInfoAdapter.MyViewHolder> {
    ...
    Context context;
    List<BookingInformation> bookinginfoList;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        if(bookinginfoList != null) {
            ...
            holder.txt_address.setText(bookinginfoList.get(position).getCustomerAddress());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView txt_service_name, txt_address,txt_time,txt_time_remain, txt_category_name;
        LinearLayout dialog;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            txt_address =itemView.findViewById(R.id.txt_user_address_booking);
